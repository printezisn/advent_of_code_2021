...
let totalSteps = calculateMinSteps(states, 0, [-1, 0], [board.length, board[0].length - 1]);
totalSteps = calculateMinSteps(states, totalSteps, [board.length, board[0].length - 1], [-1, 0]);
totalSteps = calculateMinSteps(states, totalSteps, [-1, 0], [board.length, board[0].length - 1]);
